...
#include "settings-override.h"
    ...
    */
    ...
    #define PORT_TOUCHMPR121_ENABLE          // When enabled, buttons can be connected via Touch-Controller MPR121
    ...
    //#define RFID_READER_TYPE_PN5180       // use PN5180
        ...
        constexpr uint8_t rfidGain = 0x05 << 4;      // Sensitivity of RC522. For possible values see reference: https://forum.espuino.de/uploads/default/original/1X/9de5f8d35cbc123c1378cad1beceb3f51035cec0.png
    #endif
    ...
    */
    ...
    // RFID-RC522
    #define RFID_SCAN_INTERVAL 600                      // Interval-time in ms (how often is RFID read?)
