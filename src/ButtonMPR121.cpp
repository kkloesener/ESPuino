...
#ifdef PORT_TOUCHMPR121_ENABLE
    i2c_tsafe_execute(ButtonMPR121_Init_func,30);

    if (touchsensor.isRunning()) {

    touchsensor.autoSetElectrodes();  // autoset all electrode settings
    i2c_tsafe_execute(ButtonMPR121_update,30);
